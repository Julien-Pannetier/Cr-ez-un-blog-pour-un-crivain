            ...
            <div class="container-fluid">
                ...
                <form action="index.php?action=updateComment&amp;id=<?= htmlspecialchars($comment->id()) ?>" method="POST">
                    <div class="form-group">
                        ...
                        <input class="form-control rounded-0 py-4" id="author" type="text" name="author" value="<?= htmlspecialchars_decode($comment->author()) ?>" readonly />
                    </div>
                    <div class="form-group">
                        <label for="textarea"></label>
                        <textarea id="textarea" name="comment"><?= htmlspecialchars_decode($comment->comment()) ?></textarea>
                    </div>
